...
class CalcpkgOutput:
    """Writable object used as output for the printd() function- the default
    place for stuff to be outputted"""
    ...
    def setupLogFile(self):
        """Set up the logging file for a new session- include date and
        some whitespace"""
        self.logWrite("\n###############################################")
    ...
    def getLoggingLocation(self):
        """Return the path for the calcpkg.log file - at the moment, only use
        a Linux path since I don't know where Windows thinks logs should go."""
