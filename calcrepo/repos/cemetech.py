...
class CemetechRepository(repo.CalcRepository):
    ...
    def updateFromArchivePage(self, archiveRoot, names, files, parent="/",
                              verbose=False):
        """Helper function that works recursively over Cemetech file
        ...
        while folderString in working:
            ...
            if folder != "" and folder.count("/") > parent.count("/"):
                ...
                self.updateFromArchivePage(
                    archiveRoot, names, files, folder, verbose)
    ...
    def getFileInfo(self, fileUrl, fileName):
        ...
        infoUrl = "http://www.cemetech.net/programs/index.php?mode=file&path=" + \
            fileUrl
